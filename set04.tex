...
\byline{Terry Pratchett in \textit{Wyrd Sisters}, not about the cubic curve known as the Witch of Agnesi.}
...
the derivative $D(\mathrm{inv})_{A_0}(H)$, i.e., the derivative of the inverse map at $A_0 \in GL_2(\R)$ and in the direction $H\in M_n(\R)$.
\end{problem}
